...
<head>
    ...
    <link rel="icon" href="https://laracasts.com/images/logo/logo-triangle.svg" type="image/x-icon">
    <title>Laravel</title>
    ...
    <div class="min-h-full">
                        ...
                        @auth
                            <div class="ml-4 flex items-center md:ml-6">
                                ...
                                <form method="POST" action="/logout">
                                    @csrf
                                    <button type="submit"
                                        class="ml-4 flex items-center gap-2 md:ml-6 rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                        Logout
                                    </button>
                                </form>
                            </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">Gaddour</div>
                            <div class="text-sm font-medium text-gray-400">Gaddour@example.com</div>
                        </div>
                        <button type="button"
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex items-center justify-between">
                ...
                <x-link-button href="/jobs/create">Create a new job</x-link-button>
